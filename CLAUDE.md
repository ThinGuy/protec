...
- snap run fails with "Couldn't open libEGL.so.1" (fixed: opengl plug provides host GPU stack; staging EGL/GL libs intercepted dlopen chain causing "No provider of eglGetPlatformDisplayEXT" — removed staged libs)
